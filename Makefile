...
BUILD_DIR  ?= obj_dir
SIM_MAIN   ?= simulator/sim_main.cpp simulator/i_mem.cpp simulator/d_mem.cpp simulator/commit_log.cpp simulator/kanata.cpp

CXXFLAGS  ?= -std=c++17 -O2
VERILATOR_FLAGS ?= --cc --exe --trace-fst --trace-structs --trace-depth 99 -Wall -Wno-UNUSED -Wno-WIDTH -Wno-PINCONNECTEMPTY -MMD --assert
